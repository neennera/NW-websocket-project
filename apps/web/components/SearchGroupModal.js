  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const url = searchQuery 
        ? `http://localhost:3001/api/groups/search?name=${encodeURIComponent(searchQuery)}`
        : 'http://localhost:3001/api/groups/search';
                    ...
                    <button
                      ...
                      onMouseEnter={(e) => {
                        if (joining !== group.id) {
                          ...
                          e.currentTarget.style.boxShadow = '0 4px 12px rgba(168, 184, 158, 0.3)';
                        }
                      }}
                      onMouseLeave={(e) => {
                        if (joining !== group.id) {
                          e.currentTarget.style.transform = 'scale(1)';
                          e.currentTarget.style.boxShadow = '0 2px 8px rgba(168, 184, 158, 0.2)';
                        }
                      }}
                    >
