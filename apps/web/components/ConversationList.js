export default function ConversationList({ groups, onGroupClick, onAddMember }) {
  ...
  return (
    <div>
      {/* Group Chats Section */}
      {groupChats.length > 0 && (
        <div style={{ marginBottom: groupChats.length > 0 && dms.length > 0 ? '2rem' : 0 }}>
          <h3 style={{ 
            fontSize: '1.125rem', 
            fontWeight: 'bold', 
            color: '#C9A882',
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  <button
                    ...
                    style={{
                      padding: '0.5rem 1rem',
                      background: 'linear-gradient(135deg, #A8B89E 0%, #8B9E7D 100%)',
                      color: 'white',
                      border: 'none',
                      borderRadius: '10px',
                      fontSize: '0.875rem',
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow = '0 4px 10px rgba(168, 184, 158, 0.4)';
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = 'scale(1)';
                      e.currentTarget.style.boxShadow = '0 2px 6px rgba(168, 184, 158, 0.3)';
                    }}
                  >
                    + Member
                  </button>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            {dms.map((dm) => (
              <div
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = 'translateY(-2px)';
                  e.currentTarget.style.boxShadow = '0 6px 16px rgba(232, 196, 184, 0.2)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'translateY(0)';
                  e.currentTarget.style.boxShadow = '0 2px 8px rgba(232, 196, 184, 0.1)';
                }}
              >
                <div style={{ flex: 1 }}>
                  <h3 style={{ 
